...
pub enum NumericalTraceEventKind {
    ...
    ContourLevelStarted,
    ContourRootIsolationStarted,
    ContourTransferRootConverged,
    ContourTransferRootRejected,
    ContourTransferIncidenceInvalid,
    ContourInvariantLevelCoincidence,
    ...
    StableTopologyBuilt,
    StableTopologyReused,
    StableIsothermsRebuilt,
